...
cask "tuna-adoptopenjdk14-openj9-jre" do
  version "14.0.2+12"
  sha256 "5e7a2770592b1f6d6138d6ed020b487f508b1562f30c6ba789cda836726bba51"

  # github.com/AdoptOpenJDK was verified as official when first introduced to the cask
  url "https://mirrors.tuna.tsinghua.edu.cn/AdoptOpenJDK/14/jre/x64/mac/OpenJDK14U-jre_x64_mac_openj9_14.0.2_12_openj9-0.21.0.pkg"
  appcast "https://github.com/AdoptOpenJDK"
  name "AdoptOpenJDK14 (OpenJ9) (JRE)"
