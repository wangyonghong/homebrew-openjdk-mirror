...
cask "tuna-adoptopenjdk14-jre" do
  version "14.0.2+12"
  sha256 "6e645faff5a7d2aa748b16a1af0e904a5ff2ee9fb1849bfffe132ee56a6b7567"

  # github.com/AdoptOpenJDK was verified as official when first introduced to the cask
  url "https://mirrors.tuna.tsinghua.edu.cn/AdoptOpenJDK/14/jre/x64/mac/OpenJDK14U-jre_x64_mac_hotspot_14.0.2_12.pkg"
  appcast "https://github.com/AdoptOpenJDK"
  name "AdoptOpenJDK14 (JRE)"
